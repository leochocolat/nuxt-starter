<template>
  <div class="main page-coming-soon js-scroll-container">
    <div class="js-scroll-content">
      <div class="page-coming-soon__container container">
        <span class="page-coming-soon__loading js-loading blink">loading</span>
        <Navbar />
        <SectionComingSoon />
